...
def update_application_status(request, application_id):
    ...
    try:
        ...
        if new_status not in ['pending', 'approve', 'rejected', 'flagged']:
        ...
        # Create audit log (you can expand this)
        logger.info(f"Application {application_id} status changed from {old_status} to {new_status} by admin")
